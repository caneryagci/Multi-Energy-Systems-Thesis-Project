...
model weibull_random_wind_speed_generator
  Modelica.Blocks.Interfaces.RealInput scale(min = 0) annotation(
    Placement(visible = true, transformation(origin = {-88, 46}, extent = {{-20, -20}, {20, 20}}, rotation = 0), iconTransformation(origin = {-80, 60}, extent = {{-20, -20}, {20, 20}}, rotation = 0)));
  Modelica.Blocks.Interfaces.RealInput shape(min = 0) annotation(
    Placement(visible = true, transformation(origin = {-92, -48}, extent = {{-20, -20}, {20, 20}}, rotation = 0), iconTransformation(origin = {-80, -40}, extent = {{-20, -20}, {20, 20}}, rotation = 0)));
