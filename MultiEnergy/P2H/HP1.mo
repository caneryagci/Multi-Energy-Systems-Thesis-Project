...
if Tamb < Tdesign then
  ...
  Pelec = Pord;
annotation(
    Icon(coordinateSystem(initialScale = 0.1), graphics = {Rectangle(extent = {{-100, 100}, {100, -100}}), Text(origin = {-27, 36}, extent = {{-45, 34}, {33, -22}}, textString = "Tambient"), Text(origin = {-27, -76}, extent = {{-33, 20}, {33, -20}}, textString = "Porder"), Text(origin = {52, 97}, extent = {{-12, 13}, {36, -41}}, textString = "Qgen"), Text(origin = {5, 4}, lineColor = {0, 0, 255}, extent = {{-49, 30}, {77, -42}}, textString = "Heat Pump")}));
end HP1;
