...
//Real i_an(start=i_an_0);
  ...
  Modelica.Blocks.Interfaces.RealInput ppO annotation(
    Placement(visible = true, transformation(origin = {28, 100}, extent = {{-20, -20}, {20, 20}}, rotation = -90), iconTransformation(origin = {56, 100}, extent = {{-20, -20}, {20, 20}}, rotation = -90)));
...
//Icell = p.i;
  ...
  annotation(
    ...
    Icon(graphics = {Rectangle(extent = {{-100, 100}, {100, -100}}), Text(origin = {-4, 21}, lineColor = {0, 0, 255}, extent = {{-68, 49}, {80, -77}}, textString = "Electrochemical"), Text(origin = {86, 29}, extent = {{-50, 51}, {4, -9}}, textString = "Pelec"), Text(origin = {74, -35}, extent = {{-38, 31}, {14, -13}}, textString = "Wpem"), Text(origin = {65, -64}, extent = {{23, -14}, {-23, 14}}, textString = "Icell")}, coordinateSystem(initialScale = 0.1)),
    Diagram);



end electrochemical_simple;
