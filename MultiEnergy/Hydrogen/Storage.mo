...
annotation(
    ...
    Icon(graphics = {Text(origin = {-82, 71}, extent = {{-10, 5}, {10, -5}}, textString = "nH2_i"), Text(origin = {-78, -26}, extent = {{-12, 6}, {8, -4}}, textString = "nH2_o"), Text(origin = {95, 74}, extent = {{-11, 4}, {7, -2}}, textString = "P_tank"), Rectangle(extent = {{-100, 100}, {100, -100}}), Text(origin = {13, -3}, lineColor = {0, 0, 255}, extent = {{-61, 39}, {45, -23}}, textString = "Storage Tank")}, coordinateSystem(initialScale = 0.1)));
