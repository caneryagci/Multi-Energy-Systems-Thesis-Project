...
model Gas_system2
  ...
  Hydrogen.Storage storage1(V = 1000)  annotation(
    Placement(visible = true, transformation(origin = {-156, 78}, extent = {{18, -18}, {-18, 18}}, rotation = 0)));
  ...
  Modelica.Blocks.Sources.Constant voltage(k = 20000)  annotation(
    Placement(visible = true, transformation(origin = {124, 108}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
...
equation
  ...
  connect(electrolyser1.nH, storage1.nH2_i) annotation(
    Line(points = {{-114, 92}, {-127, 92}, {-127, 86}, {-142, 86}}, color = {0, 0, 127}));
  connect(ramp1.y, storage1.nH2_o) annotation(
    Line(points = {{-139, 44}, {-126, 44}, {-126, 70}, {-142, 70}}, color = {0, 0, 127}));
  ...
  connect(voltage.y, AC.v) annotation(
    Line(points = {{136, 108}, {146, 108}, {146, 88}, {102, 88}, {102, 88}}, color = {0, 0, 127}));
