...
equation
  connect(combiTimeTable1.y[1], windPlant1.windSpeed) annotation(
    Line(points = {{-70, -18}, {-48, -18}, {-48, -16}, {-48, -16}}, color = {0, 0, 127}));
  ...
  connect(twoWindingTransformer1.p, bus1.p) annotation(
    Line(points = {{-38, 22}, {-38, 22}, {-38, 12}, {-38, 12}}, color = {0, 0, 255}));
  connect(windPlant1.p, bus1.p) annotation(
    Line(points = {{-38, -6}, {-38, -6}, {-38, 12}, {-38, 12}}, color = {0, 0, 255}));
  annotation(
    uses(OpenIPSL(version = "1.5.0"), Modelica(version = "3.2.3")));end Windfarm1;
