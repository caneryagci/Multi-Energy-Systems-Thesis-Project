model syncgen_caner "Synchronous machine with 4 windings - internal parameters"
  extends PowerGrids.Electrical.BaseClasses.OnePortACdqPU(final generatorConvention = true, localInit = if initOpt == InitializationOption.localSteadyStateFixedPowerFlow then LocalInitializationOption.PV else LocalInitializationOption.none);
  ...
  parameter PowerGrids.Types.ActivePower PNom = SNom "Nominal active (turbine) power";
  parameter PowerGrids.Types.PerUnit raPu "Armature resistance in p.u.";
  parameter PowerGrids.Types.PerUnit LdPu "Direct axis stator leakage in p.u.";
  parameter PowerGrids.Types.PerUnit MdPu "Direct axis mutual inductance in p.u.";
  parameter PowerGrids.Types.PerUnit mrcPu "Canay's mutual inductance in p.u.";
  parameter PowerGrids.Types.PerUnit LDPu "Direct axis damper leakage in p.u.";
  parameter PowerGrids.Types.PerUnit rDPu "Resistance of the direct axis damper in p.u.";
  parameter PowerGrids.Types.PerUnit LfPu "Excitation winding leakage in p.u.";
  parameter PowerGrids.Types.PerUnit rfPu "Resistance of the excitation windings in p.u.";
  parameter PowerGrids.Types.PerUnit LqPu "Quadrature axis stator leakage in p.u.";
  parameter PowerGrids.Types.PerUnit MqPu "Quadrature axis mutual inductance in p.u.";
  parameter PowerGrids.Types.PerUnit LQ1Pu "Quadrature axis 1st damper leakage in p.u.";
  parameter PowerGrids.Types.PerUnit rQ1Pu "Quadrature axis 2nd damper leakage in p.u.";
  parameter PowerGrids.Types.PerUnit LQ2Pu "Leakage of quadrature axis 2nd damper in p.u.";
  parameter PowerGrids.Types.PerUnit rQ2Pu "Resistance of quadrature axis 2nd damper in p.u.";
  parameter PowerGrids.Types.PerUnit DPu = 0 "Damping coefficient of the swing equation in p.u.";
  parameter Modelica.SIunits.Time H "Kinetic constant = kinetic energy / rated power";
  parameter PowerGrids.Types.Choices.ExcitationPuType excitationPuType = PowerGrids.Types.Choices.ExcitationPuType.nominalStatorVoltageNoLoad "Choice of excitation base voltage";
  ...
  parameter PowerGrids.Types.Choices.InitializationOption initOpt = systemPowerGrids.initOpt "Initialization option";
  final parameter Modelica.SIunits.AngularVelocity omegaBase = systemPowerGrids.omegaNom "Base angular frequency value";
  final parameter PowerGrids.Types.PerUnit kuf(fixed = false) "Scaling factor for excitation p.u. voltage";
  constant PowerGrids.Types.PerUnit omegaNomPu = 1 "Nominal frequency in p.u.";
  final parameter PowerGrids.Types.PerUnit lambdadPuStart(fixed = false) "Start value of lambdadPu";
  final parameter PowerGrids.Types.PerUnit lambdaqPuStart(fixed = false) "Start value of lambdaqPu";
  final parameter PowerGrids.Types.PerUnit ufPuStart(fixed = false) "Start value of exciter voltage in p.u. (Kundur base)";
  final parameter PowerGrids.Types.PerUnit ufPuInStart(fixed = false) "Start value of input exciter voltage in p.u. (user-selcted base";
  final parameter PowerGrids.Types.PerUnit ifPuStart(fixed = false) "Start value of ifPu";
  // Input variables
  ...
  PowerGrids.Types.PerUnit iDPu(start = 0) "Current of direct axis damper in p.u";
  PowerGrids.Types.PerUnit ifPu(start = ifPuStart) "Current of excitation winding in p.u.";
  PowerGrids.Types.PerUnit iQ1Pu(start = 0) "Current of quadrature axis 1st damper in p.u.";
  PowerGrids.Types.PerUnit iQ2Pu(start = 0) "Current of quadrature axis 2nd damper in p.u.";
  PowerGrids.Types.PerUnit ufPu(start = ufPuStart) "Voltage of exciter winding in p.u. (base voltage as per Kundur)";
  PowerGrids.Types.PerUnit lambdadPu(start = lambdadPuStart) "Flux of direct axis in p.u.";
 PowerGrids.Types.PerUnit lambdaqPu(start = lambdaqPuStart) "Flux of quadrature axis in p.u.";
  PowerGrids.Types.PerUnit lambdaDPu "Flux of direct axis damper in p.u";
  PowerGrids.Types.PerUnit lambdafPu "Flux of excitation winding in p.u.";
  PowerGrids.Types.PerUnit lambdaQ1Pu "Flux of quadrature axis 1st damper in p.u.";
  PowerGrids.Types.PerUnit lambdaQ2Pu "Flux of quadrature axis 1st damper in p.u.";
  PowerGrids.Types.PerUnit omegaRefPu = systemPowerGrids.omegaRef / systemPowerGrids.omegaNom "Reference frequency in p.u.";
  PowerGrids.Types.PerUnit CmPu(start = -PStart / SNom) "Mechanical torque in p.u. (base PNom/omegaBase)";
  PowerGrids.Types.PerUnit CePu(start = -PStart / SNom) "Electrical torque in p.u. (base SNom/omegaBase)";
  PowerGrids.Types.PerUnit PePu(start = -PStart / SNom) "Electrical power in p.u. (base SNom)";
  PowerGrids.Types.PerUnit PePuPNom = PePu * SNom / PNom "Electrical active power in p.u. (base PNom)";
  // SI-unit variables
  PowerGrids.Types.Frequency f = systemPowerGrids.fNom * omegaPu "Frequency of rotation of d-q axes";
