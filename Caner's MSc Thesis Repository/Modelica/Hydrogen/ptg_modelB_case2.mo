...
model ptg_modelB_case2
  ...
  Modelica.Blocks.Interfaces.RealInput gas_demand annotation(
    Placement(visible = true, transformation(origin = {-92, 60}, extent = {{-20, -20}, {20, 20}}, rotation = 0), iconTransformation(origin = {-92, 60}, extent = {{-20, -20}, {20, 20}}, rotation = 0)));
  Modelica.Blocks.Interfaces.RealInput P_order annotation(
    Placement(visible = true, transformation(origin = {-116, 10}, extent = {{-20, -20}, {20, 20}}, rotation = 0), iconTransformation(origin = {-116, 10}, extent = {{-20, -20}, {20, 20}}, rotation = 0)));
  Modelica.Blocks.Interfaces.RealInput T_ambient annotation(
    Placement(visible = true, transformation(origin = {-114, -18}, extent = {{-20, -20}, {20, 20}}, rotation = 0), iconTransformation(origin = {-114, -18}, extent = {{-20, -20}, {20, 20}}, rotation = 0)));
  Modelica.Blocks.Interfaces.RealInput ptg_switch annotation(
    Placement(visible = true, transformation(origin = {-106, 38}, extent = {{-20, -20}, {20, 20}}, rotation = 0), iconTransformation(origin = {-106, 38}, extent = {{-20, -20}, {20, 20}}, rotation = 0)));
equation
  ...
  connect(gas_demand, storage2.nH2_o) annotation(
    Line(points = {{-92, 60}, {-38, 60}, {-38, 58}, {-38, 58}}, color = {0, 0, 127}));
  connect(gas_demand, controller_P2G3.demand) annotation(
    Line(points = {{-92, 60}, {-58, 60}, {-58, 84}, {26, 84}, {26, 54}, {34, 54}, {34, 52}}, color = {0, 0, 127}));
  connect(P_order, electrolyser_detailed1.Porder) annotation(
    Line(points = {{-116, 10}, {-82, 10}, {-82, 10}, {-82, 10}}, color = {0, 0, 127}));
  connect(T_ambient, electrolyser_detailed1.T_ambient) annotation(
    Line(points = {{-114, -18}, {-86, -18}, {-86, -16}, {-84, -16}}, color = {0, 0, 127}));
  connect(ptg_switch, controller_P2G3.ptg_switch) annotation(
    Line(points = {{-106, 38}, {16, 38}, {16, 44}, {36, 44}, {36, 44}}, color = {0, 0, 127}));
protected
  annotation(
