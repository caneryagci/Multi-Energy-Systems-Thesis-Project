...
model Windfarm7
  ...
  parameter Real _P0=1.6 "Active Power from Power Flow";
  ...
  iPSL.Electrical.Buses.Bus bus annotation(
    Placement(visible = true, transformation(origin = {5, 15}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  iPSL.Electrical.Buses.InfiniteBus infiniteBus(P_0 = 0.5)  annotation(
    Placement(visible = true, transformation(origin = {-40, 15}, extent = {{10, -10}, {-10, 10}}, rotation = 0)));
  inner iPSL.Electrical.SystemBase SysData(S_b = 100)  annotation(
    Placement(visible = true, transformation(origin = {115, 90}, extent = {{-10, -10}, {14, 10}}, rotation = 0)));
  Modelica.Blocks.Sources.CombiTimeTable windspeed(fileName = "C:/Users/Caner/Desktop/Multi-Energy-Systems-Thesis-Project/Co_simulation/Base Case/windspeed.txt", smoothness = Modelica.Blocks.Types.Smoothness.ContinuousDerivative, tableName = "tab1", tableOnFile = true) annotation(
    Placement(visible = true, transformation(origin = {-109, 62}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
protected
  function cp_init
    input Real lambda;
    input Real theta;
...
equation
  connect(generator1.Pgen, turbine_Model1.Pelec) annotation(
    Line(visible = true, origin = {-0.1428, 48.5266}, points = {{53.1428, 9.4734}, {60.1428, 9.4734}, {60.1428, -8.085}, {-59.4803, -8.085}, {-59.4803, -1.38836}, {-54.4677, -1.38836}}, color = {0, 0, 127}));
  connect(turbine_Model1.Pord, electrical_Control1.Pord) annotation(
    Line(visible = true, origin = {-25.6589, 60.1024}, points = {{-12.9516, -0.01612}, {2.6464, -0.01612}, {2.6464, 0.0162}, {7.6589, 0.0162}}, color = {0, 0, 127}));
  connect(const.y, electrical_Control1.Qord) annotation(
    Line(visible = true, origin = {-25.1902, 68.958}, points = {{-14.3805, 1.7491}, {7.1902, 1.7491}, {7.1902, -3.498}}, color = {0, 0, 127}));
  ...
  connect(generator1.Qgen, electrical_Control1.Qgen) annotation(
    Line(visible = true, origin = {26.605, 49.271}, points = {{26.395, 4.729}, {31.4075, 4.729}, {31.4075, -4.8235}, {-44.605, -4.8235}, {-44.605, 0.189}}, color = {0, 0, 127}));
  connect(generator1.Vt, electrical_Control1.Vterm) annotation(
    Line(visible = true, origin = {17.5, 65.2993}, points = {{35.5, 2.12607}, {40.5125, 2.12607}, {40.5125, 7.7132}, {-40.5125, 7.7132}, {-40.5125, -9.8393}, {-35.5, -9.8393}}, color = {0, 0, 127}));
  connect(generator1.p, bus.p) annotation(
    Line(points = {{45, 50}, {45, 50}, {45, 15}, {5, 15}, {5, 15}}, color = {0, 0, 255}));
  connect(infiniteBus.p, bus.p) annotation(
    Line(points = {{-30, 15}, {5, 15}, {5, 15}, {5, 15}}, color = {0, 0, 255}));
  annotation (
