...
model pth_modelB_case1
  ...
  Modelica.Blocks.Interfaces.RealInput heat_demand annotation(
    Placement(visible = true, transformation(origin = {-78, 74}, extent = {{-20, -20}, {20, 20}}, rotation = 0), iconTransformation(origin = {-78, 74}, extent = {{-20, -20}, {20, 20}}, rotation = 0)));
  ...
  Modelica.Blocks.Interfaces.RealInput P_order annotation(
    Placement(visible = true, transformation(origin = {-86, -4}, extent = {{-20, -20}, {20, 20}}, rotation = 0), iconTransformation(origin = {-86, -4}, extent = {{-20, -20}, {20, 20}}, rotation = 0)));
equation
  ...
  connect(T_ambient, hp2.Tamb) annotation(
    Line(points = {{-78, 28}, {-50, 28}, {-50, 22}, {-36, 22}, {-36, 20}}, color = {0, 0, 127}));
  connect(heat_demand, storage.Q_demand) annotation(
    Line(points = {{-78, 74}, {-38, 74}, {-38, 70}, {-24, 70}, {-24, 72}}, color = {0, 0, 127}));
  connect(heat_demand, controller_APL.demand) annotation(
    Line(points = {{-78, 74}, {-38, 74}, {-38, 88}, {22, 88}, {22, 72}, {34, 72}, {34, 72}}, color = {0, 0, 127}));
  ...
  connect(P_order, hp2.Pord) annotation(
    Line(points = {{-86, -4}, {-38, -4}, {-38, -8}, {-36, -8}}, color = {0, 0, 127}));
protected


end pth_modelB_case1;
