...
def grid_net():
    ...
    #pp.create_transformer_from_parameters(net, bus1, bus2, sn_mva=20, vn_hv_kv=110, vn_lv_kv=33, vkr_percent=1, vk_percent=1, pfe_kw=1, i0_percent=1, shift_degree=0, tap_phase_shifter=False, in_service=True, name='Trafo', index=None, max_loading_percent=90, parallel=1, df=1.0)
        ...
        #create 110 kV lines
    pp.create_line(net, bus2, bus3, length_km=20., std_type='NAYY 4x120 SE', max_loading_percent=100)
        
        #create loads
    l1 = pp.create_load(net, bus3, p_mw=50, q_mvar=0, sn_mva=60, min_p_mw=23,max_p_mw=50, max_q_mvar=40, min_q_mvar=-40, scaling=1.0, in_service=True, controllable=False,name='Power2Gas',)
    l2 = pp.create_load(net, bus3, p_mw=45, q_mvar=0, sn_mva=60, min_p_mw=22,max_p_mw=50, max_q_mvar=40, min_q_mvar=-40, scaling=1.0, in_service=True, controllable=False,name='Power2Heat',)
    l3 = pp.create_load(net, bus3, p_mw=0, q_mvar=0, sn_mva=240, min_p_mw=0,max_p_mw=200, max_q_mvar=50, min_q_mvar=-50, scaling=1.0, in_service=True, controllable=False,name='Electrical')
    l4 = pp.create_load(net, bus3, p_mw=100, q_mvar=0, sn_mva=20, min_p_mw=0,max_p_mw=20, max_q_mvar=20, min_q_mvar=-20, scaling=1.0, in_service=True, controllable=False,name='Electrical_base')
