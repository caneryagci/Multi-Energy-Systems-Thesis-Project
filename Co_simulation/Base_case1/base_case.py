...
my_world.add_powerflow('grid1', grid_loc, inputs = ['WF.P', 'PV.P','Power2Heat.P','Power2Gas.P'], outputs=['Bus 0.V', 'Bus 1.V', 'Bus 2.V', 'WF.P', 'PV.P',
...
ax20.set_xlabel("Time [s]", fontsize=15)
