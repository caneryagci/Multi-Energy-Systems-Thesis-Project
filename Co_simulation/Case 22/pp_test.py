...
#cost = -100
my_world = World(stop_time=43200, logging = True, clean_up = False, interpolate_results=False, exchange = 900)
...
my_world.add_powerflow('grid1', grid_loc, inputs = ['WF.max_p_mw', 'PV.max_p_mw', 'Power2Gas.max_p_mw','Power2Gas.min_p_mw',
                                                    'Power2Gas.cp1_eur_per_mw','Power2Heat.max_p_mw','Power2Heat.min_p_mw',
                                                    'Power2Heat.cp1_eur_per_mw'], 
